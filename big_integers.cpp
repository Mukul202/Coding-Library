...
int main() {
    ...
    cin>>a>>b>>c;
    Int cur=pow(b,c);
    vector<int>unit_digits[10];
            unit_digits[0]={0,0,0,0};
            unit_digits[1]={1,1,1,1};
            unit_digits[2]={6,2,4,8};
            unit_digits[3]={1,3,9,7};
            unit_digits[4]={6,4,6,4};
            unit_digits[5]={5,5,5,5};
            unit_digits[6]={6,6,6,6};
            unit_digits[7]={1,7,9,3};
            unit_digits[8]={6,8,4,2};
            unit_digits[9]={1,9,1,9};
    auto unit_digit=a%10;
    if(unit_digit==0 or unit_digit==1 or unit_digit==5 or unit_digit==6){
        out(unit_digit);
    }else if(unit_digit==4 or unit_digit==9){
        if(cur%10==0){
            if(unit_digit==4){
                out(6);
            }else{
        ...
        int divide=cur%4;
        out(unit_digits[unit_digit][divide]);
    }
}
